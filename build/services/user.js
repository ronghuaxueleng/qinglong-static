...
let UserService = class UserService {
    ...
    async getAuthInfo() {
        const content = await fs.readFile(config_1.default.authConfigFile, 'utf8');
        return (0, util_1.safeJSONParse)(content);
    }
    async updateAuthInfo(authInfo, info) {
        await fs.writeFile(config_1.default.authConfigFile, JSON.stringify(Object.assign(Object.assign({}, authInfo), info)));
    }
