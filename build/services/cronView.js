...
let CronViewService = class CronViewService {
    ...
    async update(payload) {
        ...
        const tab = new cronView_1.CrontabView(Object.assign(Object.assign({}, doc), payload));
    ...
    async checkPosition(position) {
        ...
        if (precisionPosition < env_1.minPosition || precisionPosition > env_1.maxPosition) {
